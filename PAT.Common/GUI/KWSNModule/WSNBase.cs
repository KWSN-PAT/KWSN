...
namespace PAT.Common.GUI.KWSNModule
{
    public interface IWSNBase
    {
        ...
        WSNPNData GeneratePNXml(XmlDocument doc, float xShift, float yShift);
    ...
    public class WSNUtil
    {
        ...
        /// <returns></returns>
        public static WSNPNData GetPNXml(XmlDocument PNRes, string pnId, string itemId, float xShift, float yShift)
        {
            WSNPNData data = null;
            string tmp;
